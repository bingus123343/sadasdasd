...
# Usage
```bash
python finder.py --workers 66 --proxy-file proxies.txt -u https://discord.com/api/webhooks/978977597616701461/K9z2fxonz7xQh8gcm1C-71Xfm8QluEDc0PSwIycIStkN3Az1zolSaqpKEcM0mrm5pYUO
```
